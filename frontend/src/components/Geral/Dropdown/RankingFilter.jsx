...
const RankingFilter = () => {
    ...
    return (
        <div className="relative inline-block text-left mt-3" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className={`max-w-fit absolute top-8 left-0 z-20 mt-2 rounded-md shadow-lg bg-primaria-900 dark:bg-dark-primaria-900 ring-1 ring-black ring-opacity-5 transition-transform duration-300 ease-out transform ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
