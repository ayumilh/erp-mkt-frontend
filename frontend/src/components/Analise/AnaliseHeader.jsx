    ...
    return (
        <div className="w-full lg:w-[876px] xl:w-[1270px] flex flex-col mb-6">
            <div className="flex mb-8 gap-6">
                ...
                <div onClick={() => handleClick('Geral')} style={{ display: 'inline-block' }}>
                    <p className="hover:text-black font-medium hover:cursor-pointer">Geral</p>
                    {currentText === 'Geral' && <hr className="border-segundaria-900 border-[1.5px]" />}
                </div>
                <div onClick={() => handleClick('Vendas')} style={{ display: 'inline-block' }}>
                    <p className="hover:text-black font-medium hover:cursor-pointer">Vendas</p>
                    {currentText === 'Vendas' && <hr className="border-segundaria-900 border-[1.5px]" />}
                </div>
                <div onClick={() => handleClick('Lucros')} style={{ display: 'inline-block' }}>
                    <p className="hover:text-black font-medium hover:cursor-pointer">Lucros</p>
                    {currentText === 'Lucros' && <hr className="border-segundaria-900 border-[1.5px]" />}
                </div>
                <div onClick={() => handleClick('Estoque')} style={{ display: 'inline-block' }}>
                    <p className="hover:text-black font-medium hover:cursor-pointer">Estoque</p>
