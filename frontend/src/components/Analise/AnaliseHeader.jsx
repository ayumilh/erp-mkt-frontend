        ...
        <div className="w-full flex flex-col xl:flex-row justify-between mb-6">
            <div className="flex gap-4">
                ...
                <button onClick={() => handleClick('Lucros')} className={`${currentText === 'Lucros' ? 'border-b-2 border-segundaria-900' : 'border-transparent'} flex items-center justify-center px-2 md:px-3 py-2 border-b-2 border-segundaria-900 hover:border-b-2 hover:border-gray-300 transform focus:-translate-y-0.5 focus:scale-60 transition duration-300 ease-in-out`}>
                    <p className="hover:text-black dark:text-gray-300 dark:hover:text-white  font-medium cursor-pointer">Lucros</p>
                </button>
            ...
            <div className="hidden lg:flex flex-wrap gap-3 justify-start md:justify-end px-4 md:px-0 md:gap-6">
                <div className="flex flex-row">
                    <button className="px-4 py-2 text-sm text-neutral-800 dark:text-gray-300 dark:hover:text-white hover:text-black font-medium border border-gray-200 hover:bg-gray-200 dark:hover:bg-neutral-800 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-gray-300">
                        Últimos 7 dias
                    </button>
                    <button className="px-4 py-2 text-sm text-neutral-800 dark:text-gray-300 dark:hover:text-white hover:text-black font-medium border border-gray-200 hover:bg-gray-200 dark:hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-gray-300">
                        Últimos 30 dias
                    </button>
                    <button className="px-4 py-2 text-sm text-neutral-800 dark:text-gray-300 dark:hover:text-white hover:text-black font-medium border border-gray-200 hover:bg-gray-200 dark:hover:bg-neutral-800 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-gray-300">
                        Este mês
                    </button>
                </div>
                {/* <div>
