            ...
            if (shippingIdCounts[pedido.shipping_id] > 1) {
              if(!firstRender[pedido.shipping_id]){
                ...
                return (
                  <tr key={index} className='hover:bg-gray-100 cursor-pointer' onClick={() => handleModal(shipping_id, true)}>
                    ...
                    <td className='w-40 md:w-60 lg:w-64 xl:w-80 pl-3 pr-4 py-4 md:py-5'>
                    ...
                    <td className="px-4 py-4 md:py-5 text-sm font-medium text-center">{pedido.total_amount}</td>
                    <td className="px-4 py-4 md:py-5 text-sm font-medium text-center">{pedido.buyer_nickname}</td>
                    <td className="px-4 py-4 md:py-5 text-sm font-medium text-center">
              ...
              return (
                <tr key={index} className='border-b border-gray-200 hover:bg-gray-100 cursor-pointer' onClick={() => handleModal(pedido.shipping_id)}>
                  ...
                  <td className="w-40 md:w-60 lg:w-64 xl:w-80 pl-3 pr-4 py-2 md:py-5 text-start"><p className='w-40 md:w-60 lg:w-64 text-sm font-medium'>{pedido.reason}</p></td>
      ...
      <tr>
        <td className="text-center" colSpan="7">
          <div className="w-52 ml-10 md:ml-0 md:px-10 md:w-full py-12">
            ...
            <p className="mt-8">Uh-oh! Parece que não há pedidos, estamos ansiosos para apoiar suas próximas vendas!</p>
          </div>
        </td>
      </tr>
    )}
