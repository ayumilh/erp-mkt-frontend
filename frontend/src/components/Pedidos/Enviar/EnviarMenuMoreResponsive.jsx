...
export const EnviarMenuMoreResponsive = ({ showCheckboxes, showCheckboxesAll, setShowCheckboxes, setShowCheckboxesAll, shippingIdOrder, currentPage, totalPages, rowsPerPage, handlePageChange, handleRowsPerPageChange }) => {
