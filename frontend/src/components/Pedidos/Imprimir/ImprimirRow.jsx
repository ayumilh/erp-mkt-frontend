...
export default function ImprimirRow({ setOrder, setToggleShowCheckboxes, toggleShowCheckboxesAll, setShippingIdOrder, searchTerm, searchColumn, filteredOrders }) {
  ...
  useEffect(() => {
    ...
    fetchOrders();
  }, [searchTerm, searchColumn, filteredOrders]);
