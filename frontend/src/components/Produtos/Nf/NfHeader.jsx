    ...
    <div className="w-full lg:w-[876px] xl:w-[1270px] flex flex-col mb-6">
      <div className="flex mb-8 gap-6">
        <div style={{ display: 'inline-block' }}>
          <p className="hover:text-black font-medium hover:cursor-pointer">Todas as NF-e</p>
          <hr className="border-segundaria-900 border-[1.5px]" />
        </div>
        <div style={{ display: 'inline-block' }}>
          <p className="hover:text-black font-medium hover:cursor-pointer">Invalidar Nº da NF-e</p>
          {/* <hr className="border-segundaria-900 border-[1.5px]" /> */}
        </div>
      </div>
      ...
      <div className="flex gap-3 justify-end">
        <div className="flex flex-row gap-0 md:gap-6">
          <BtnRoute route="/Nf" size='full' btn='base' txt='base'>
        ...
        <div>
          <BtnActive title="Exportar" page="/produtos/Nf" size="btnHeader"/>
        </div>
      </div>
    </div>
  )
