...
const QuickActions = () => {
  return (
    <div className='w-full flex lg:hidden justify-start items-center mb-4 gap-3'>
        <div className='w-1/3 h-20 py-2 px-2 bg-primaria-800 flex flex-col justify-center items-center rounded-lg active:shadow-md active:-translate-y-1 active:scale-60 transition duration-500 ease-in-out'>
