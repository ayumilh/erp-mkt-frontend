...
const ChartLojasContent = () => {
  ...
  return (
    <div className="bg-primaria-900 shadow-lg border border-slate-100 rounded-2xl w-full px-4 lg:px-5 xl:px-8 py-5 xl:py-7 mb-7 lg:mb-0 mx-2 xs:mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h2 className='text-base text-neutral-700 font-semibold'>Lojas</h2> 
