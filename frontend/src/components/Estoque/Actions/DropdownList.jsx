			...
			{isOpenLista && (
				<div className="origin-top-center absolute mt-2 px-2 rounded-md bg-primaria-900">
					<div className="w-28 my-2" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
						<button className="flex justify-between w-full text-sm font-medium px-2 py-1 hover:text-black hover:bg-white rounded-sm hover:bg-opacity-80 transition duration-200 ease-in-out" role="menuitem">
							SKU
						</button>
						<button className="flex justify-between w-full text-sm font-medium px-2 py-1 hover:text-black hover:bg-white rounded-sm hover:bg-opacity-80 transition duration-200 ease-in-out" role="menuitem">
							KIT SKU
