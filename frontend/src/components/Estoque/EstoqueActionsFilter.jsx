...
const EstoqueActionsFilter = () => {
  return (
    <div className="bg-primaria-900 dark:bg-dark-primaria-900 hover:shadow-input transition-all ease-in duration-500 rounded-2xl xl:flex w-[345px] md:w-[728px] lg:w-[903px] xl:w-[1270px] min-h-max px-4 py-5 xl:px-8 xl:items-center justify-center">
      ...
      <form className="mt-[14px] md:flex md:justify-around xl:ml-5">
        ...
        <div className="flex items-center rounded w-full md:w-[270px] lg:w-[360px] relative">
          ...
          <input title='Pesquisar por' className="w-full dark:bg-neutral-800 dark:text-gray-200 rounded overflow-hidden text-xs md:text-sm font-normal pl-8 pr-3 py-2" type="text" placeholder="Pesquise por N° da estante, Armazém e etc" style={{ textOverflow: 'ellipsis', whiteSpace: 'nowrap' }} />
        ...
        <div className="flex mt-4 md:mt-0 xl:ml-5">
          <select title='Número da estante' className="rounded dark:bg-neutral-800 px-3 py-2 mr-2 w-1/2 lg:w-[160px] xl:w-[200px] text-xs md:text-sm text-neutral-800 dark:text-gray-200 font-normal" name="nEstante" id="nEstante">
          ...
          <select title='Armazém' className="rounded dark:bg-neutral-800 px-3 py-2 w-1/2 lg:w-[160px] xl:w-[200px] text-xs md:text-sm text-neutral-800 dark:text-gray-200 font-normal" name="status" id="Armazem">
